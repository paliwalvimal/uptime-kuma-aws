...
[Uptime Kuma](https://github.com/louislam/uptime-kuma) is a self-hosted uptime monitoring tool to track the availability and response times for web services.
